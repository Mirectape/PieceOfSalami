using System;
using StringTransmutations.Exceptions;

namespace StringTransmutations
{
    public class StringToNumber
    {
        ...
        public static double StrToDouble(string s)
        {
            ...
            if((intPart + decimalPart)>= Double.MaxValue) //without sign assigned we check on max and min values both
            {
